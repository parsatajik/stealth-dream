...
const RefundPolicyPage = () => {
  return (
    <>
      <Helmet>
        <title>Refund Policy - Artefice</title>
        <meta
          name="description"
          content="At Artefice, we stand by our unique, AI-infused fashion pieces. Learn about our Refund Policy and our commitment to your satisfaction."
        />
      </Helmet>
      <Box
        display="flex"
      ...
      >
        ...
        <Text>
          ...
          have not fulfilled your order yet. However, no changes can be made
          once your order has been fulfilled and shipped out of our warehouse.
        </Text>
        ...
        <Text>
          ...
          reasons) for exchanges and will not send over a replacement. Please
          make sure of your items before placing your order (!!!!)
        </Text>
        ...
        <Text fontWeight="bold">
          To be eligible for a return, your items must be unworn, unwashed, and
          in its original condition, with all tags attached.
        </Text>

        <Text>
          * Please note you will be responsible to pay for return shipping
          costs. The original shipping cost is non-refundable as we've incurred
          the cost to ship the items to you already.
        </Text>
        <Text>
          We strongly suggest purchasing a return label that has tracking if
          your order value is high (in case your package gets lost) We will not
          be liable for any lost return packages.
        </Text>
        ...
        <Text>
          ...
          the item is defective, damaged or if you've received the wrong item.
          We will evaluate the issue with photos and make it right for you,
          don't worry {":)"}
        </Text>

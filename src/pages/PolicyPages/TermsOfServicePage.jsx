...
const TermsOfServicePage = () => {
  return (
    <>
      <Helmet>
        <title>Terms of Service - Artefice</title>
        <meta
          name="description"
          content="Understand your rights and responsibilities as an Artefice customer. Read our Terms of Service for detailed information."
        />
      </Helmet>
      <Box
        display="flex"
      ...
      >
        ...
        <Text>
          This website is operated by Artefice. Throughout the site, the terms
          “we”, “us” and “our” refer to Artefice. Artefice offers this website,
        ...
        <Text>
          Our store is hosted on Vercel and we use Stripe to sell our products
          and services to you.
        </Text>
        <Text fontWeight="bold" mb="-15px">
          SECTION 1 - ONLINE STORE TERMS SECTION 1 - ONLINE STORE TERMS
        </Text>
        <Text>
        ...
        <Text>
          ...
          use, the service is at your sole risk.
        </Text>
        <Text>
          ...
          non-infringement. In no case shall The Company, our directors,
        ...
        <Text>
          You agree to indemnify, defend and hold harmless Drmers Club and our
